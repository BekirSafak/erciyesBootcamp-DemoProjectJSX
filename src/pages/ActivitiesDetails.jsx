                        ...
                        <div className="mt-8 max-w-md grid grid-cols-1">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className='flex justify-between px-2 py-4 border-t-2'>
                                    <Link className='bg-purple-400 hover:bg-purple-800 duration-300 text-white px-5 py-1 rounded-full border-none'>Rezervasyon Yap</Link>
                                    <button className='bg-purple-800 hover:bg-purple-400 duration-300 text-white px-5 py-1 rounded-full border-none'>Satın Al</button>
                                </div>
                            </div>
