                                    ...
                                    <Box className='absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg p-6 rounded-xl max-w-[550px] items-center' >
                                        <Typography id="modal-modal-title" variant="h6" component="h2">
                                            <div className='flex justify-between items-center text-center'>
                                                <p className='select-none font-bold text-purple-800 text-2xl'>PEŞİN FİYATINA 3 VEYA 6 TAKSİT!</p>
                                                <div>
                                        ...
                                        <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                            <img className='max-h-[160px] md:max-h-[200px] w-full object-fill rounded-xl' src={require('../assets/campainImg/campain.png')} alt="" />
                                            <ul className='list-decimal text-gray-400 py-2 px-6'>
                                                <li className='mt-2'>30 Kasım 2023 tarihine kadar Trendyol’da 500 TL ve üzeri işlemlerde peşin fiyatına 3 taksit, 6.000 TL üzeri işlemlerde peşin fiyatına 6 taksit imkanı sunulacaktır.</li>
                                                <li className='mt-2'>3 veya 6 taksit kampanyasına Bonus, Money Bonus, Flexi, Bonus Flexi, Bonus Genç, Bonus Business, Shop&Fly, Shop&Fly Business , Miles&Smiles Garanti BBVA , Miles&Smiles Garanti BBVA Business, American Express Card, Bonus American Express Card, Miles&Smiles American Express card, Shop&Fly American Express Card, Deniz Bonus, TEB Bonus, Şeker Bonus, ING Bonus, Türkiye Finans Happy Card, Alternatifbank Bonus, ICBC Turkey Bonus, Deniz Bonus Business, TEB Bonus Business, Şeker Bonus Business, Alternatifbank Bonus Business, ICBC Turkey Bonus Business, Türkiye Finans Happy Business Card dahildir.</li>
                                                <li className='mt-2'>Paracard dahil değildir.</li>
                                                <li className='mt-2'>Kampanyaya ek kartlar ve sanal kartlar dahildir.</li>
                                                <li className='mt-2'>Bu kampanya Garanti BBVA tarafından düzenlenmektedir.</li>
                                            </ul>
                                        </Typography>
                                    </Box>
                                </Modal>
                                <Link onClick={handleOpen} className='bg-white hover:bg-slate-100 px-5 py-1 mx-2 bottom-4 rounded-full border-none'>Detaylar</Link>
