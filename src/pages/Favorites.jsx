            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-4'>
                {favorites.map((item, index) => (
                    <div key={index} className='border shadow-lg rounded-lg hover:scale-105 duration-300 relative'>
                        <FaHeartCircleMinus size={25} className='absolute opacity-80 hover:opacity-100 duration-300 rounded-full right-2 top-2 text-white cursor-pointer hover:text-purple-300 scale-100 hover:scale-125'></FaHeartCircleMinus   >
